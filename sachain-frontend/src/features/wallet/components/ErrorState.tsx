...
export default function ErrorState({ onRetry, onClose }: ErrorStateProps) {
  return (
    <div className="p-6 text-center">
      ...
      <h3 className="text-xl font-semibold mb-4 text-red-600">Connection Failed</h3>
      <p className="mb-6 text-gray-600">We couldn't connect to your wallet. Please try again.</p>
