...
export function Step2ShareOffering({
  data,
  onChange,
  onNext,
  onPrev,
  ...
  const validate = () => {
    ...
    if (!data.targetFundingGoal || data.targetFundingGoal <= 0)
      newErrors.targetFundingGoal =
        'Target funding goal must be greater than 0';
  ...
  const isFieldValid = (field: string) => {
    switch (field) {
      case 'stockSupply':
        return (
          typeof data.stockSupply === 'number' &&
          data.stockSupply > 0 &&
          data.stockSupply <= 10
        );
      case 'pricePerStock':
      ...
      case 'targetFundingGoal':
        return (
          typeof data.targetFundingGoal === 'number' &&
                ...
                {allFieldsValid() ? (
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {formatCurrency(data.targetFundingGoal)} of{' '}
                        {formatCurrency(calculateMaxRaise())}
                      </p>
                    </div>
                    ...
                    {!isGoalRealistic() && (
                      <Alert variant="destructive" className="mt-4">
                        ...
                        <AlertDescription className="text-xs">
                          Your funding goal exceeds the maximum possible raise.
                          Reduce your goal or increase shares/price.
                        </AlertDescription>
                      </Alert>
                    )}
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <div className="text-xs text-foreground">
                            ...
                            <p className="text-muted-foreground mt-1">
                              Your goal is {getFundingProgress().toFixed(0)}% of
                              maximum capacity, leaving room for growth.
                            </p>
                          </div>
                        </div>
                      </div>
