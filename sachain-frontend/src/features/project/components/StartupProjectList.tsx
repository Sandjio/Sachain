...
//           Get started by creating your first project to begin raising funds and managing investors.
//         </p>
//         {onCreateProject && (
...
//             className="h-8"
//           >
//             <RefreshCw className={`h-3 w-3 mr-2 ${(loading || isRefreshing) ? 'animate-spin' : ''}`} />
//             Refresh
//           </Button>
//         </div>
//       </div>
...
//                 <div key={project.projectId || project.id} className="flex-shrink-0 w-80">
//                   <ProjectCard
//                     project={project}
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-medium text-foreground">Project Portfolio</h2>
            <p className="text-sm text-muted-foreground">
              {loading ? 'Loading...' : `${projectsMemo.length} project${projectsMemo.length !== 1 ? 's' : ''}`}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          {projectsMemo.length > 0 && (
            <Badge variant="secondary" className="text-xs">
              {projectsMemo.filter((p: any) => p.status === 'active').length} Active
            </Badge>
          )}
          <Button
            variant="outline"
