...
export function ProjectCard({ project, onViewDetails }: ProjectCardProps) {
  const { deleteProject: deleteProjectFromStore } = useProjectStore();
  ...
  const displayData = {
    ...
    raised: "$0", // TODO: Calculate from investments
    investors: 0, // TODO: Calculate from investments  
    daysLeft: "30", // TODO: Calculate from createdAt
    progressPercent: 0, // TODO: Calculate: raised/goal * 100
    image: project.coverImageUrl,
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      await deleteProjectFromStore(project.projectId);
    } catch (error) {
