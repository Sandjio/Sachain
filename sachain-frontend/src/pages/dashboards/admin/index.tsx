      ...
      <DashboardLayout>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground">No items.</CardContent>
          </Card>
          <Card>
            <CardHeader><CardTitle>Moderation</CardTitle></CardHeader>
            <CardContent className="text-sm text-muted-foreground">No actions required.</CardContent>
          </Card>
        </div>
      </DashboardLayout>
    </RequireAuth>
