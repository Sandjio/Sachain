                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      <span className="font-medium text-gray-900">Average Funding Rate</span>
                    ...
                    <div className="w-full bg-white rounded-full h-2 shadow-inner">
                      <div 
                        ...
                        style={{ width: `${Math.min(100, projectStats.avgFunding)}%` }}
                      />
                    </div>
                    <p className="text-sm text-[#123962] mt-1">{projectStats.avgFunding.toFixed(1)}% on average</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-[#123962] mt-1">{projectStats.successRate}% successful projects</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="p-4 rounded-lg bg-gradient-to-br from-[#90A5FB]/5 to-transparent hover:from-[#90A5FB]/10 transition-colors">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Projects launched this month</span>
                ...
                <div className="p-4 rounded-lg bg-gradient-to-br from-[#90A5FB]/5 to-transparent hover:from-[#90A5FB]/10 transition-colors">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Funding deadline this week</span>
          ...
          <Card className="bg-white border-0 shadow-sm">
            <CardHeader className="p-4 sm:p-6 border-b">
              <CardTitle className="flex flex-col sm:flex-row sm:items-center gap-3">
                ...
                <span className="text-lg sm:text-xl text-gray-900">Edit Project</span>
              </CardTitle>
            </CardHeader>
            <CardContent className="p-4 sm:p-6">
              <ProjectEditForm
