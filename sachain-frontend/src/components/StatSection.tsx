      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Africa&apos;s startup ecosystem is booming, but access to capital
            remains a challenge. sachain bridges this gap with
          ...
          {stats.map((stat, index) => (
            ...
            >
              <CardContent className="p-8 text-center">
                <div
                  className={`inline-flex items-center justify-center w-16 h-16 ${stat.bgColor} rounded-full mb-6 group-hover:scale-110 transition-transform duration-300`}
                >
        ...
        <div className="mt-16 bg-gradient-to-r from-purple-50 to-blue-50 rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Purpose-built to unlock Africa&apos;s innovation potential through
              accessible, secure crowdfunding
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Every investment creates jobs and drives economic growth across
                Africa
              </p>
            </div>
